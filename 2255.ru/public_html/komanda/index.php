...
$APPLICATION->SetTitle("Занимайся с профессионалами ");
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"PROPERTY_CODE" => array("POST","UNLIMITED","GUEST_VISIT","FREEZING","COLOR",""),
		"SET_BROWSER_TITLE" => "N",
		"SET_LAST_MODIFIED" => "N",
	...
	Array(
		...
		"PARENT_SECTION_CODE" => "",
		"PREVIEW_TRUNCATE_LEN" => "",
		"PROPERTY_CODE" => array("SCHEDULE","SALARY","EXPERIENCE","EMPLOYMENT",""),
		"SET_BROWSER_TITLE" => "N",
		"SET_LAST_MODIFIED" => "N",
		"SET_META_DESCRIPTION" => "N",
		"SET_META_KEYWORDS" => "N",
